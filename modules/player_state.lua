...
AddEventHandler("vRP:playerSpawn", function(user_id, source, first_spawn)
  ...
  if data == nil or tmpdata == nil then
    Debug.pend()
    return
  end

  if first_spawn then -- first spawn
    -- cascade load customization; ox_inventory owns weapons
    ...
    if data.customization ~= nil then
      vRPclient.setCustomization(source,{data.customization},function() -- delayed health, because model respawn
...
function tvRP.updateWeapons(weapons)
  -- ox_inventory owns weapon state.
end
