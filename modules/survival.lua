      ...
      if nuser_id ~= nil then
        vRPclient.isInComa(nplayer,{}, function(in_coma)
          if in_coma then
            ...
            TriggerClientEvent("pNotify:SendNotification", player,{text = "Ikke i koma!", type = "error", queue = "global", timeout = 3000, layout = "centerLeft",animation = {open = "gta_effects_open", close = "gta_effects_close"}})
          end
        end)
      else
